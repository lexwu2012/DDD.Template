...
namespace ThemePark.Application.DataSync
{
    public class FtpWeb
    {
        ...
        /// <returns></returns>
        public bool Upload(string sourceFileName, string destFileName)
        {
            FileInfo fileInf = new FileInfo(sourceFileName);
            string uri = ftpURI + destFileName;
        ...
        public string[] GetFileList(string mask)
        {
            ...
            {
                if ((webEx.Response as FtpWebResponse)?.StatusCode == FtpStatusCode.ActionNotTakenFileUnavailable)
                {
                    Insert_Standard_ErrorLog.Insert("FtpWeb", "GetFileList Error --> " + webEx.Message.ToString());
