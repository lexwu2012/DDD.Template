...
namespace ThemePark.Infrastructure.Security
{
    ...
    public sealed class RsaHelper
    {
        ...
        /// 签名
        /// </summary>
        /// <param name="data">需要签名的内容</param>
        /// <param name="privateKey">私钥</param>
        /// <param name="charset">编码格式</param>
        public static string Sign(string data, string privateKey, string charset = "utf-8")
        {
            return RSASignCharSet(data, privateKey, charset);
        }
        ...
        /// <param name="privateKey">私钥</param>
        /// <param name="charset">编码格式</param>
        private static string RSASignCharSet(string data, string privateKey, string charset = "utf-8")
        {
