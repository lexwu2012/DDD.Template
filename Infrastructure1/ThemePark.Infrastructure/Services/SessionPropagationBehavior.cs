...
{
    public class SessionPropagationBehavior : IEndpointBehavior
    {
        ...
        public void ApplyDispatchBehavior(ServiceEndpoint endpoint, EndpointDispatcher endpointDispatcher)
        {
            ...
            {
                dispatchOperation.CallContextInitializers.Add(new SessionContextInitializer());
            }
        }
        ...
        {
            var inspector = IocManager.Instance.Resolve<SessionMessageInspector>();
